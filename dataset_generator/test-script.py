...
# print(LwordPreprocessor.fix_ending_subbranches("F[-F][+F]F[-F]F-F+F[-F[+F-F]][+F]F[-F]"))
# print()
# print(LWordPreprocessor.check_syntax(""))
# print(LWordPreprocessor.check_syntax("F"))
# print(LWordPreprocessor.check_syntax("["))
# print(LWordPreprocessor.check_syntax("[]"))
# print(LWordPreprocessor.check_syntax("[]]"))
# print(LWordPreprocessor.check_syntax("[]]["))
# print(LWordPreprocessor.check_syntax("F+F[F]"))
# print(LWordPreprocessor.check_syntax("F+F[F][-F[+F]][F[-F][+F]]"))
# print(LWordPreprocessor.check_syntax("F+F[F][-F[+F]][F[-F][+F]"))
# print(LWordPreprocessor.check_syntax("F+F[F][-F[+F]][F[-F][]]["))
